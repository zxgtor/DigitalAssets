...
| 2 | Projects | ✅ Shipped | 1 | Organize Gallery entries into projects. Commit `4496b78`. |
| 3 | Characters library | ✅ Shipped | 1 | Reusable subjects + reference images. Commit `0498e70`. |
